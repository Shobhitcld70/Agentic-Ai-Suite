...
if 'chat_threads' not in st.session_state:
    # initialize from DB
    st.session_state['chat_threads'] = {tid: "Chat" for tid in retrieve_all_threads()}
...
if user_input:
    ...
    if st.session_state['chat_threads'][st.session_state['thread_id']] in ["New Chat", "Current Chat", "Chat"]:
